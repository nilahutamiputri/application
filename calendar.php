  ...
  <body>
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-xss-8">
          <pre>$('[data-toggle=calendar]').calendar();</pre>
        </div>
      </div>
      <hr>
      ...
      <div class="row">
        ...
        <div class="col-xss-8">
          <pre>$('[data-toggle=calendar]').calendar({
          unavailable: ['*-*-8', '*-*-10']
});				
			</pre>
        </div>
      ...
      <hr>
      <h2>Custom day names, month names (Vietnamese)</h2>
      <div class="row">
        <div class="col-xss-4">
    ...
    $(document).ready(function()
    {
      ...
      $('#glob-data').calendar(
      {
        unavailable: ['2017-05-08','2017-05-09','2017-05-10','2017-05-11']
      });
      ...
      $('#custom-name').calendar(
      {
        ...
        month_name: ['Januari', 'Tháng Hai', 'Tháng Ba', 'Tháng Tư', 'Tháng Năm', 'Tháng Sáu', 'Tháng Bảy', 'Tháng Tám', 'Tháng Chín', 'Tháng Mười', 'Tháng Mười Một', 'Tháng Mười Hai'],
        unavailable: ['2014-07-10']
      });
